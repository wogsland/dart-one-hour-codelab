...
["", "piratebadge.dart", , A, {
  ...
  updateBadge: [function(e) {
    ...
    if (t1.length === 0) {
      ...
      t2.textContent = "Now, tell us it's nameses!";
    } else {
      J.set$disabled$x(t2, true);
      t2.textContent = "Stupid, fat hobbit.";
    }
  }, "call$1", "updateBadge$closure", 2, 0, 10],
  ...
  }, "call$1", "generateBadge$closure", 2, 0, 10],
  main_closure: {
    "^": "Closure:13;inputField_0",
    call$1: function(_) {
  ...
  main_closure0: {
    ...
    call$1: function(arrr) {
      P.print("Error getting JSON file: " + H.S(arrr));
      $.badgeNameElement.textContent = "No nameses :(";
    }
  },
  PirateName: {
    ...
    static: {"^": "PirateName_indexGen,PirateName_names,PirateName_appellations", PirateName$: function(appellation, firstName) {
      ...
      }, "call$1", "PirateName__parsePirateNamesFromJSON$closure", 2, 0, 11]}
  }
},
1],
]);
